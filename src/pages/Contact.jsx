                ...
                <div className="mt-6 pt-6 border-t-2 border-gray-200">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      Télécharger le formulaire CERFA 14798 (déclaration préalable)
                    </a>
                    <a 
                      href="https://www.strasbourg.eu/plan-local-urbanisme-eurometropole-strasbourg"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 text-sm text-yellow-600 hover:text-yellow-700 font-medium transition-colors"
                    >
                      ...
                      Consulter le Plan Local d'Urbanisme (PLU) de Strasbourg
                    </a>
                  </div>
                </div>
              </form>
