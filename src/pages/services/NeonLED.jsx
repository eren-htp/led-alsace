...
function NeonLED() {
  ...
  const avantages = [
    { icon: Lightbulb, title: "Éclairage Lumineux moderne", description: "Technologie Lumineux dernière génération, économique et durable" },
  ...
  return (
    <div className="min-h-screen">
      ...
      <HeroSlider 
        images={heroImages}
        title="Illuminez votre espace avec du néon Lumineux"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16">Pourquoi choisir le néon Lumineux ?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-12">Applications du néon Lumineux</h2>
      ...
      {/* FAQ */}
      <FAQ 
        title="Questions fréquentes sur les néons Lumineux"
        faqs={[
          {
            question: "Quelle est la différence entre un néon Lumineux et un néon traditionnel au gaz ?",
            answer: "Un néon traditionnel est un tube de verre rempli de gaz (néon ou argon), éclairé par décharge électrique. Le néon Lumineux, quant à lui, imite le rendu visuel du néon mais fonctionne grâce à des bandes de Lumineux intégrées dans des gaines souples ou rigides. Il offre un rendu lumineux similaire avec de nombreux avantages : consommation réduite, absence de gaz, solidité accrue et personnalisation sur-mesure."
          },
          {
            question: "Pourquoi choisir un néon Lumineux pour une enseigne ou une décoration professionnelle ?",
            answer: "Le néon Lumineux est un excellent choix pour les professionnels souhaitant un effet lumineux impactant, moderne et économique. Il attire l'œil, fonctionne en basse tension (sécurité), consomme peu d'énergie et peut être fabriqué dans toutes les formes : logo, slogan, pictogramme, etc. C'est aussi une solution durable, idéale pour les commerces, bars, restaurants, bureaux ou événements."
          },
          {
            question: "Est-ce que le néon Lumineux peut être utilisé en extérieur ?",
            answer: "Oui. LED ALSACE propose des néons Lumineux étanches (IP65 ou plus) adaptés à une utilisation en extérieur, résistants aux intempéries et aux variations de température. Que ce soit pour une façade de commerce ou une signalétique extérieure design, nous concevons des néons Lumineux durables et sécurisés, avec une installation conforme aux normes."
          },
          {
            question: "Le néon Lumineux est-il personnalisable en forme, couleur et taille ?",
            answer: "Absolument. Le néon Lumineux est l'un des supports les plus flexibles du marché. Nous pouvons reproduire votre logo, signature, texte, forme spécifique dans des dizaines de couleurs et plusieurs types de finitions (lumière directe, indirecte, clignotante, RVB...). La taille est entièrement ajustable selon votre espace."
          },
          {
            question: "Quelle est la durée de vie moyenne d'un néon Lumineux professionnel ?",
            answer: "Un néon Lumineux de qualité professionnelle a une durée de vie moyenne comprise entre 30 000 et 50 000 heures, soit plusieurs années d'utilisation continue. Contrairement aux néons au gaz, il ne s'affaiblit pas progressivement et ne contient pas de composants fragiles (verre, électrodes). Un entretien minimal est suffisant."
          },
          {
            question: "Est-ce que le néon Lumineux est plus économique qu'un néon traditionnel ?",
            answer: "Oui. Le néon Lumineux consomme en moyenne 5 à 10 fois moins d'électricité qu'un néon au gaz pour un rendu équivalent. Il ne nécessite pas de transformateur haute tension, n'émet pas de chaleur excessive, et réduit fortement les coûts de maintenance. C'est un investissement rentable sur le long terme."
          },
          {
            question: "Quels sont les délais pour fabriquer un néon Lumineux sur-mesure chez LED ALSACE ?",
          ...
          {
            question: "Est-ce que le néon Lumineux chauffe ou présente un danger ?",
            answer: "Non. Le néon Lumineux fonctionne en basse tension (12V ou 24V), ce qui le rend très sûr, y compris dans les espaces accessibles au public. Il ne chauffe pas significativement, ne risque pas de se briser comme le verre, et peut être installé dans des lieux sensibles (enfants, ERP, etc.)."
          },
          {
            question: "Peut-on fixer un néon Lumineux sur tout type de surface ?",
            answer: "Oui. Nos nNéon Lumineux peuvent être fixés sur mur, vitrine, panneau ou support suspendu. Nous proposons des systèmes de fixation adaptés : entretoises, rails, colles spéciales ou ventouses pour les vitrines temporaires. Chaque projet inclut une étude de pose personnalisée."
          },
          {
            question: "LED ALSACE propose-t-elle la création de néons Lumineux pour les événements ou les salons ?",
            answer: "Oui. Nous réalisons des néons Lumineux événementiels pour stand, exposition, shooting photo ou décoration temporaire. Faciles à transporter et à installer, ils donnent un cachet visuel immédiat à votre espace. Nous proposons aussi la location courte durée pour certains modèles standards."
          }
        ]}
      />
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-black">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Projet de néon Lumineux sur mesure ?</h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">Contactez-nous pour créer votre néon Lumineux personnalisé</p>
