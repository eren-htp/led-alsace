...
function NeonLED() {
  ...
  const avantages = [
    { icon: Lightbulb, title: "Éclairage Lumineuse moderne", description: "Technologie Lumineuse dernière génération, économique et durable" },
  ...
  return (
    <div className="min-h-screen">
      ...
      <HeroSlider 
        images={heroImages}
        title="Illuminez votre espace avec du néon Lumineuse"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16">Pourquoi choisir le néon Lumineuse ?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-12">Applications du néon Lumineuse</h2>
      ...
      {/* FAQ */}
      <FAQ 
        title="Questions fréquentes sur les néons Lumineuse"
        faqs={[
          {
            question: "Quelle est la différence entre un néon Lumineuse et un néon traditionnel au gaz ?",
            answer: "Un néon traditionnel est un tube de verre rempli de gaz (néon ou argon), éclairé par décharge électrique. Le néon Lumineuse, quant à lui, imite le rendu visuel du néon mais fonctionne grâce à des bandes de Lumineuse intégrées dans des gaines souples ou rigides. Il offre un rendu lumineux similaire avec de nombreux avantages : consommation réduite, absence de gaz, solidité accrue et personnalisation sur-mesure."
          },
          {
            question: "Pourquoi choisir un néon Lumineuse pour une enseigne ou une décoration professionnelle ?",
            answer: "Le néon Lumineuse est un excellent choix pour les professionnels souhaitant un effet lumineux impactant, moderne et économique. Il attire l'œil, fonctionne en basse tension (sécurité), consomme peu d'énergie et peut être fabriqué dans toutes les formes : logo, slogan, pictogramme, etc. C'est aussi une solution durable, idéale pour les commerces, bars, restaurants, bureaux ou événements."
          },
          {
          ...
          {
            question: "Est-ce que le néon Lumineuse chauffe ou présente un danger ?",
            answer: "Non. Le néon Lumineuse fonctionne en basse tension (12V ou 24V), ce qui le rend très sûr, y compris dans les espaces accessibles au public. Il ne chauffe pas significativement, ne risque pas de se briser comme le verre, et peut être installé dans des lieux sensibles (enfants, ERP, etc.)."
          },
          {
            question: "Peut-on fixer un néon Lumineuse sur tout type de surface ?",
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-black">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Projet de néon Lumineuse sur mesure ?</h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">Contactez-nous pour créer votre néon Lumineuse personnalisé</p>
