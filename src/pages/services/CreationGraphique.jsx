    ...
    <div className="min-h-screen bg-white">
      ...
      <FAQ 
        ...
        faqs={[
          ...
          {
            question: "Quels services de création graphique propose Lumineuse ALSACE ?",
            answer: "Lumineuse ALSACE accompagne les entreprises du Grand Est dans tous leurs besoins graphiques : Création de logo et d'identité visuelle, Déclinaison de charte graphique, Conception de supports imprimés (flyers, brochures, cartes), Création de visuels pour réseaux sociaux ou sites web, et Habillage graphique d'enseignes, véhicules, vitrines, etc. Nous travaillons sur-mesure, selon vos besoins, votre secteur d'activité et vos contraintes."
          },
          {
            question: "Quelle est la différence entre un graphiste freelance et un studio comme Lumineuse ALSACE ?",
            answer: "Un studio comme Lumineuse ALSACE offre une approche complète et structurée : nous combinons les compétences graphiques, techniques et stratégiques pour livrer des visuels adaptés à chaque support (print, digital, signalétique…). Contrairement à un freelance isolé, nous pouvons gérer des projets complexes, multi-supports et suivre l'ensemble de la chaîne de production (de la création à l'impression ou la pose)."
          },
          {
          ...
          {
            question: "Est-ce que Lumineuse ALSACE peut moderniser un logo existant ?",
          ...
          {
            question: "Combien coûte une création graphique chez Lumineuse ALSACE ?",
          ...
          {
            question: "Lumineuse ALSACE peut-elle gérer à la fois la création graphique et l'impression ?",
          ...
          {
            question: "Quels logiciels utilise Lumineuse ALSACE pour la création graphique ?",
          ...
          {
            question: "Est-ce que Lumineuse ALSACE propose des visuels pour les réseaux sociaux ou le web ?",
