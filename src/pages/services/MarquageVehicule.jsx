...
function MarquageVehicule() {
  // Configuration SEO
  const seoData = servicesSEOConfig.marquageVehicule
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-400 to-yellow-600">
        <div className="container mx-auto px-4 t          <h2 className="text-3xl md:text-5xl font-bold text-lumineuse-dark mb-6">
            Prêt à transformer votre véhicule en support publicitaire ?
          </h2>Name="text-xl text-gray-900 mb-8 max-w-2xl mx-auto">Contactez-nous pour un devis gratuit et personnalisé</p>
