    ...
    <div className="min-h-screen">
      ...
      <FAQ 
        ...
        faqs={[
          ...
          {
            question: "Lumineuse ALSACE peut-elle produire des petites séries ou des pièces uniques en découpe laser ?",
