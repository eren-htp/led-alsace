      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300">Panneaux directionnels, totems, plaques pour intérieur et extérieur</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-gray-700 text-lg leading-relaxed">Créez une signalétique claire et efficace pour guider vos visiteurs. Panneaux directionnels, totems extérieurs, plaques de porte, signalétique PMR - solutions complètes pour tous environnements.</p>
          </div>
        </div>
      </section>
